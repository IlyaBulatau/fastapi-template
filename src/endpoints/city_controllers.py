...
async def get_city_by_id(city_id: int, city_repo: BaseRepositiry = Depends(CityRepositiry)):
...
async def create_city(city_name: str, city_repo: BaseRepositiry = Depends(CityRepositiry)):
